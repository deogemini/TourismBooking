 ...
 <head>
  ...
  <script type="text/javascript" src="bootstrap/bootstrap/js/bootstrap.js"></script>
  	<link rel="stylesheet" href="/All in oneproject/Assert/style.css">
	<link rel="stylesheet" href="/All in oneproject/Assert/slick.css">
  </head>
...
-- <input type="file" name="" accept="image/*" style="display: none;" placeholder="Picture"> --
		...
		<div class="site-container" id="nationalpark">
			<div class="about-me-slider">
				<div>
					...
					<img src="/All in oneproject/Assert/serenget.jpg" alt="quotes svg">
					<!-- <h4>David Dixon</h4>
					<p>Reader</p> -->
				</div>
				<div>
 ...
 -->				</div>
	...
	<div>
					...
					<img src="/All in oneproject/Assert/saadani.jpg" alt="quotes svg">
									</div>
    ...
    <div class="site-container">
      <div class="social">
        ...
        <div class="social-icons">
          <a href="#" target="_blank"><img src="/All in oneproject/Assert/social-twitter.png" alt="social icon"></a>
          <a href="#" target="_blank"><img src="/All in oneproject/Assert/social-pinterest.png" alt="social icon"></a>
  ...
  <!---scripts--->
  	<script src="/All in oneproject/Assert/jquery.min.js"></script>
	<script src="/All in oneproject/Assert/slick.min.js"></script>
	<script src="/All in oneproject/Assert/main.js"></script>
	<script src="/All in oneproject/bootstrap/bootstrap/js/bootstrap.js"></script>
 </body>
 </html>